      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="card text-center bg-gradient-to-br from-blue-50 to-blue-100">
            <div className="text-4xl font-bold text-blue-600 mb-2">{totalStats.quizzes}</div>
            <div className="text-gray-700 font-medium">Total Quizzes</div>
          </div>
          <div className="card text-center bg-gradient-to-br from-purple-50 to-purple-100">
            <div className="text-4xl font-bold text-purple-600 mb-2">{totalStats.questions}</div>
          ...
          <div className="card text-center bg-gradient-to-br from-green-50 to-green-100">
            <div className="text-4xl font-bold text-green-600 mb-2">{totalStats.correct}</div>
          ...
          <div className="card text-center bg-gradient-to-br from-amber-50 to-amber-100">
            <div className="text-4xl font-bold text-amber-600 mb-2">{totalStats.average}%</div>
            <div className="text-gray-700 font-medium">Average Score</div>
          </div>
        </div>
        ...
        <div className="card mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {Object.entries(stats).map(([category, stat]) => {
              ...
              return (
                <div key={category} className="p-4 border-2 border-gray-200 rounded-lg hover:border-primary-400 transition-colors">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{stat.totalQuizzes} quizzes</p>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">Average:</span>
                      <span className="font-bold text-primary-600">{stat.averageScore}%</span>
                    </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-bold">{info.name}</h3>
                      <p className="text-sm text-gray-600">{formatDate(quiz.timestamp)}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-6">
                    <div className="text-right">
                      <div className="text-2xl font-bold" style={{
                        color: percentage >= 80 ? '#10b981' : percentage >= 60 ? '#3b82f6' : '#ef4444'
                      }}>
                        {percentage}%
                      </div>
